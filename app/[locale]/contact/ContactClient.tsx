      ...
      <div className="relative z-10 flex min-h-screen flex-col lg:flex-row">
        ...
        >
          ...
          <div className="space-y-6">
            {[
              { icon: <LuMail className="h-5 w-5 text-accent" />, label: t('emailInfoLabel'), value: 'contact@seranya-blog.com' },
              { icon: <LuMessageSquare className="h-5 w-5 text-accent" />, label: t('responseLabel'), value: t('responseValue') },
            ].map((item) => (
            ...
            <Form form={form} layout="vertical" onFinish={onFinish}>
              ...
              <motion.div variants={fadeUp}>
                <Form.Item
                  ...
                  label={label(<LuTag className="h-4 w-4 text-accent" />, t('subjectLabel'))}
                >
                  <Input
              ...
              <motion.div variants={fadeUp}>
                <Form.Item
                  name="message"
                  rules={[{ required: true, message: t('required') }]}
                  label={label(<LuMessageSquare className="h-4 w-4 text-accent" />, t('messageLabel'))}
                >
                  <TextArea
                    rows={6}
