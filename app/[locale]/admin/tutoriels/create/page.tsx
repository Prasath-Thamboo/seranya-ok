      ...
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-2xl">
        ...
        >
          ...
          <div className="mb-4 rounded-md border border-dashed border-gray-300 p-4">
            ...
            >
              <Input placeholder="Tutorial title" style={{ height: '3rem' }} />
            </Form.Item>

            <Form.Item
              name="descriptionEn"
              label={<span className="font-sans text-ink-soft">Description (EN)</span>}
              className="mb-0"
            >
              <Input.TextArea placeholder="Tutorial description" style={{ height: '6rem' }} />
            </Form.Item>
          </div>
