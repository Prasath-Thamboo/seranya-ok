...
const UpdatePost = () => {
      ...
      const loadPost = async () => {
        try {
          ...
          if (data) {
            ...
            setContentEnValue(data.contentEn || '');
  ...
  const handleSubmit = async (values: UpdatePostModel) => {
    ...
    try {
      ...
      // Version anglaise — envoyée même vide pour permettre l'effacement (le
      // backend traite '' comme null sur les colonnes *En).
      formData.append('titleEn', values.titleEn || '');
      formData.append('introEn', values.introEn || '');
      formData.append('subtitleEn', values.subtitleEn || '');
      formData.append('contentEn', contentEnValue || '');
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-3xl">
        ...
        >
          ...
          <div className="mb-4 rounded-md border border-dashed border-gray-300 p-4">
            ...
            <Form.Item
              name="titleEn"
              label={<span className="text-ink-soft font-sans">Title (EN)</span>}
            >
              <Input placeholder="Post title" className="bg-raised text-ink font-sans" />
            </Form.Item>

            <Form.Item
              name="introEn"
              label={<span className="text-ink-soft font-sans">Introduction (EN)</span>}
            >
            ...
            <Form.Item
              name="subtitleEn"
              label={<span className="text-ink-soft font-sans">Subtitle (EN)</span>}
            >
              <Input placeholder="Post subtitle" className="bg-raised text-ink font-sans" />
            </Form.Item>

            <Form.Item label={<span className="text-ink-soft font-sans">Content (EN)</span>} className="mb-0">
